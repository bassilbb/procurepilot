<x-guest-layout>
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-slate-900">Choose a new password</h2>
        <p class="mt-1 text-sm text-slate-500">Your new password must be different from the previous one.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <div class="relative mt-1">
                ...
                <x-text-input id="email" class="block w-full pl-10" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="you@company.com" />
            </div>
